...
FILE_AUTHORIZED_PATHS: Final[Path] = CONFIG_DIR / "file_authorized_paths.json"
ROUTING_CONFIG: Final[Path] = CONFIG_DIR / "agent_routing.yaml"
TRIGGERS_CONFIG: Final[Path] = CONFIG_DIR / "toolbox_triggers.yaml"
CYBER_KEYWORDS_CONFIG: Final[Path] = CONFIG_DIR / "workflows" / "cyber_workflow_keywords.yaml"
