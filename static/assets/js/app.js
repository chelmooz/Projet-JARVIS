...
function populateDefaultModelSelect() {
    ...
    const models = availableModels.length > 0 ? availableModels : ['hf.co/bartowski/Qwen2.5-7B-Instruct-GGUF:Q4_K_M'];
...
// --- Analytics (OPTIMISÉ : Réutilisation des instances Chart.js) ---
let analyticsCharts = {};
