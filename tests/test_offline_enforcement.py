...
def _get_client():
    ...
    class FakeInference:
        ...
        def list_models(self): return ["hf.co/bartowski/Qwen2.5-7B-Instruct-GGUF:Q4_K_M"]
        def first_available(self): return "hf.co/bartowski/Qwen2.5-7B-Instruct-GGUF:Q4_K_M"
    ...
    ctx_mod._ctx.orchestrator.run.return_value = {
        "response": "ok", "agent": "dev", "model": "hf.co/bartowski/Qwen2.5-7B-Instruct-GGUF:Q4_K_M"
    }
