...
class TestProcessManager:
    def test_start_ollama_calls_kill_existing(self):
        with (
            patch("services.launcher.kill_existing") as mock_kill,
    ...
    def test_kill_existing_valid_port(self):
        with patch("services.port_manager.SYSTEM", "linux"), patch("services.port_manager.subprocess.run") as mock_run:
