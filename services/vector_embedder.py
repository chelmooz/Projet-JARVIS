...
class Embedder:
    ...
    def embed(self, text: str) -> list[float]:
        ...
        try:
            ...
            return list(self._inference.embed(text))
            ...
            _logger.critical(
                ...
                "La fonctionnalité RAG sera indisponible pour cette requête. Détail : %s",
                e,
            )
            raise RuntimeError("Le moteur de recherche sémantique (RAG) est temporairement indisponible.") from e
