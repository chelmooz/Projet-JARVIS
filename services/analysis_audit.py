...
class QualityAuditor:
    ...
    def _audit_structure(self, report: dict[str, Any]) -> None:
        ...
        has_project_files = os.path.exists(os.path.join(_PROJECT_ROOT, "pyproject.toml")) and os.path.isdir(
    ...
    def _register_node_import(
        ...
        if isinstance(node, ast.Import):
            ...
            self._register_import(
                fp, node.module or "", f"from {node.module} import ... échoué", import_issues, checked
            )
