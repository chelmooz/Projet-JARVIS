...
def _detect_gpu(cmd: list[str], vendor: str, detail_fn: Callable[[str], str]) -> dict[str, Any] | None:
...
def check_python() -> dict[str, Any]:
    ...
    portable_ok = os.path.exists(selected_python) and os.path.abspath(selected_python).startswith(
        os.path.abspath(PORTABLE_DIR)
    )
