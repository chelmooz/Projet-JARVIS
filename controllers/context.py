...
async def _body_size_limiter(request: Request, call_next: Callable[[Request], Awaitable[JSONResponse]]) -> JSONResponse:
...
def get_app_context(request: Request) -> AppContext:
    """Dépendance principale : retourne le contexte de l'application avec fallback sur le singleton _ctx."""
