...
async def get_analytics(context: AppContext = Depends(get_app_context)) -> Any:
...
async def get_peak(context: AppContext = Depends(get_app_context)) -> Any:
